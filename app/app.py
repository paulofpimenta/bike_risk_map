...
accidents_data = pd.read_csv("app/accidents_by_zone.csv", index_col=[0])
accidents_data['index'] = accidents_data.index

arrondis_gdf = gpd.read_file("app/arrondissements.geojson")

zones_gdf = gpd.read_file("app/zones.geojson")

accidents_paris_ll = gpd.read_file("app/accidents_paris_ll.geojson")
...
with open("app/zones.json") as response:
